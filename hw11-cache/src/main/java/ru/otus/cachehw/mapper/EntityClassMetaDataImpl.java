...
import ru.otus.cachehw.mapper.annotations.Column;
import ru.otus.cachehw.mapper.annotations.Id;
import ru.otus.cachehw.mapper.exceptions.ThereIsNoConstructorException;
import ru.otus.cachehw.mapper.exceptions.ThereIsNoIdException;
import ru.otus.cachehw.mapper.exceptions.TooMuchConstructorsException;
import ru.otus.cachehw.mapper.exceptions.TooMuchIdsException;
...
public class EntityClassMetaDataImpl<T> implements EntityClassMetaData<T> {
    ...
    public static <E> EntityClassMetaDataImpl<E> createByClass(Class<E> clazz){
        ...
        List<Constructor<E>> constructors = Arrays.stream(constructorsArray)
                .filter(c -> c.isAnnotationPresent(ru.otus.cachehw.mapper.annotations.Constructor.class))
                .toList();
